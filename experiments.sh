...
# Dubins car
# L1
python3 run.py --model Dubins --counterx_refresh_fraction 0.5 --counterx_fraction 0.25 --verify_batch_size 30000 --expdecrease_loss_type 2 --probability_bound 0.5 --expDecr_multiplier 100 --local_refinement --epochs 25 --perturb_counterexamples --mesh_refine_min 0.000001 --mesh_loss 0.005 --mesh_train_grid 0.05 --mesh_verify_grid_init 0.05 --mesh_verify_grid_min 0.05 --max_refine_factor 2 --plot_intermediate --no-split_lip